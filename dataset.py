...
class ImageNetDataset(Dataset):
    ...
    def load_file(self):
        ...
        if self.train:
            for i in range(1):
                data_path = f"/home/summer/Documents/GitHub/image_datasets/Imagenet64_train_part1_npz/train_data_batch_{i + 1}.npz"
            ...
            data_path = f"/home/summer/Documents/GitHub/image_datasets/Imagenet64_val_npz/val_data.npz"
            data_seg = np.load(data_path)
